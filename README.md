...
Contact: [Telegram](https://t.me/bohring3bot)

A stable telegram bot to get restricted messages with custom thumbnail support , made by Raj Bhadani. 
...
- To save from bots send link in this format : `t.me/b/bot_username/message_id` (use plus/graph messenger for message_id)
...
PYROGRAM SESSION: [SessionGen Bot](https://t.me/SessionStringGeneratorRobot) 
